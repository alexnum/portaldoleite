 ...
 */
public class OrganizadorPorDiscordancias implements IOrganizadorDeTimeLine{
    private static String QUERY_GET_DICAS = "FROM " + Dica.class.getName()  + " ORDER BY discordancias DESC";
